define({ "api": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "grant_type",
            "description": "<p>the value should be &quot;authorization_code&quot;</p>"
          },
          {
            "group": "Parameter",
            "type": "STRING",
            "optional": false,
            "field": "redirect_uri",
            "description": "<p>the value should be &quot;http://localhost:3000/api/v1/oauth2/authorize/successRedirect&quot;</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    "type": "get",
    "url": "/clients/:userId",
    "title": "Get clients for user",
    "version": "1.0.0",
    "name": "Retrieve_clients_for_a_user",
    "group": "Clients",
    "description": "<p>Returns all the clients for the given user.  If the user has no clients, it will result in a 404 error with a message saying they have no clients</p>",
    "header": {
      "fields": {
        "Header": [
          {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "clients",
            "description": "<p>list of all clients of the user</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "filename": "src/routes/auth.routes.js",
    "group": "_home_nkarasch_GitStuff_yggdrasil_endor_src_routes_auth_routes_js",
    "groupTitle": "_home_nkarasch_GitStuff_yggdrasil_endor_src_routes_auth_routes_js"
  }
] });
